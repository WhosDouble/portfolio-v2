...
function App() {
    ...
    const [animatedBackground, setAnimatedBackground] = useState("auroraBorealis");
    ...
    return (_jsx(_Fragment, { children: loading ? (_jsx(Loading, {})) : (_jsxs("div", { children: [_jsx(AnimatedBackground, { animationName: animatedBackground }), _jsx(Navbar, { nightMode: nightMode }), _jsx(MainTitle, { dynamic: darkMode })] })) }));
}
export default App;
